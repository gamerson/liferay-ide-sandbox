...
public class IDEStatsApplication extends Application {
    ...
    private final String fullrange = "?start_date=2010-02-01&end_date=2011-09-30";
    
    public IDEStatsApplication() {
    }

    public void init() {
        final Window window = new Window("IDE Stats Application");
        ...
        button.addListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				result.setCaption("getting stats...");
				String stats = getstats();
				result.setCaption(stats);
			}
		});
